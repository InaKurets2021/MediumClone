				...
				<div class="col-md-10 offset-md-1 col-xs-12">
					...
					<form @submit.prevent="onSubmit">
						<fieldset>
							...
							<fieldset class="form-group">
								<textarea type="text" class="form-control form-control-lg" placeholder="What is this article about?"
							...
							<fieldset class="form-group">
								<button type="submit" class="btn btn-lg pull-xs-right btn-primary" :disabled="isSubmitting"> Publish
									Article
								</button>
							</fieldset>
						</fieldset>
	...
	methods: {
		onSubmit() {
			const form = {
				...
				body: this.body,
				tagList: this.tagList.split('')/*для отправки на бэкэнд массива*/
			}
